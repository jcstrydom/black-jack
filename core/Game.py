...
class Game:
    ...
    def instructions(self):
        ...
        if instruct:
            ...
            print("\n\tAIM:")
            print("\n\tThe aim of the game is to get a higher hand than the House. There is a condition: you cannot have more than 21. If your hand goes over 21, you go bust.")
            ...
            print("\n\tSCORING:")
            print("\n\tEach number card scores their number in the hand. All face cards count 10. Aces count either 11 or 1, which ever benefits the players hand.")
            print("\n\tPLAYING:")
            ...
            print("\n\tOnce the players have been defined (human and robot) the cards are dealt to all players including the House.")
            print("\n\tPlay starts with the first human player and sequentially follows the list given, till the House has the final turn")
            print('\n\tBETTING:')
            print("\tWhen you place your first bet, you can only see the House's one card. You bet, and once you have placed the bet, you will see your cards." \
                  "When you see your cards for the first time, you have three options: Double down [d], Hit [h], or Stay [s]. Double down [d], allows you to double your bet while getting another card." \
                    "Double down is only available once, and is not available in any consecutive decisions of your turn. \n\tThe initial opening bet has a minimum of 50 and"
            ...
            print('\n\tWINNING:')
            print("\tEach player's cards will be evaluated directly to the House's hand.\n\tIf your hand is higher than the House, you receive your double your bet back (i.e. replacing your bet and gaining your bet in addition).")
            print("\tWhen you have Black Jack (i.e. score 21 with two cards only, e.g. Ace and 10) you receive 2.5 times your bet.")
