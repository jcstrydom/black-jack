...
class Game:
    ...
    def instructions(self):
        ...
        if instruct:
            ...
            print("\tIn essence each player plays against the House.")
            print("\n\tSCORING:")
            print("\tEach number card contributes their number to the hand's total. All face cards contribute 10. Aces count either 11 or 1, which ever benefits the player's hand.")
            print("\n\tSETUP:")
            ...
            print("\n\t   NOTE -  if the cards display with blank lines between the card lines, the CLI should be zoomed out.")
            print('\n\tBETTING:')
            ...
            print('\n\tTHE HOUSE:')
            print("\tThe House will play last of all in each round. The House will try and maximize their hand without it going bust, however it does sometimes go bust.")
            print('\n\tWINNING:')
            ...
            print("\tWhen the House goes bust then all players that have not gone bust win, regardless of their final hand. They are paid twice their bet.")
            print('\n\tEND GAME:')
